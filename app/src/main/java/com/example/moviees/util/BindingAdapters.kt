...
//    if (state is NetworkResponse.Loading<*>) view.visibility = View.VISIBLE else view.visibility = View.GONE
//
...
//    view.adapter = MovieItemAdapter(items , this)
//        .setNewData(items ?: emptyList())
//}
//@BindingAdapter(value = ["app:items"])
//fun <T> setRecyclarItems(view: RecyclerView, items: List<T?>) {
